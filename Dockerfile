...
RUN yum -y install gcc gcc-c++ make passwd openssl openssh-server lsof ftp openssh-clients svn git rpm-build java-1.8.0-openjdk-headless java-1.8.0-openjdk epel-release ansible && yum clean all \
